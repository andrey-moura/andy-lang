...
std::shared_ptr<andy::lang::structure> create_true_class(andy::lang::interpreter* interpreter)
{
    ...
    TrueClass->instance_functions = {
        {"present?", andy::lang::function("present?", andy::lang::function_storage_type::instance_function, [TrueClass](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
        ...
        {"||", andy::lang::function("||", andy::lang::function_storage_type::instance_function, {"other"}, [TrueClass](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
            return std::make_shared<andy::lang::object>(TrueClass);
        })},
        ...
        { "&&", andy::lang::function("&&", andy::lang::function_storage_type::instance_function, {"other"}, [TrueClass, interpreter](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
