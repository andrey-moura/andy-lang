...
std::shared_ptr<andy::lang::structure> create_class_class(andy::lang::interpreter* interpreter)
{
    ...
    cls->methods["new"] = andy::lang::method("new", andy::lang::method_storage_type::class_method, { "class_name" }, [interpreter](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
