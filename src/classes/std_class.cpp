...
std::shared_ptr<andy::lang::structure> create_std_class(andy::lang::interpreter* interpreter)
{
    ...
    auto StdClass = std::make_shared<andy::lang::structure>("Standard");
        ...
        StdClass->functions["print"] = std::make_shared<andy::lang::function>("print",andy::lang::function_storage_type::class_function,std::initializer_list<std::string>{"message"}, [interpreter](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
            std::shared_ptr<andy::lang::object> obj = params[0];
            if(obj->cls == interpreter->StringClass) {
                std::cout << obj->as<std::string>();
            } else {
                std::string s = obj->cls->functions["to_string"]->call(obj)->as<std::string>();
                std::cout << s;
            }
    ...
    StdClass->functions["out"] = std::make_shared<andy::lang::function>("out",andy::lang::function_storage_type::class_function,std::initializer_list<std::string>{"message"}, [interpreter](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
            std::shared_ptr<andy::lang::object> obj = params[0];
#ifdef _WIN32
    ...
    StdClass->functions["gets"] = std::make_shared<andy::lang::function>("gets",andy::lang::function_storage_type::class_function, [interpreter](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
            std::string line;
    ...
    StdClass->functions["system"] = std::make_shared<andy::lang::function>("system",andy::lang::function_storage_type::class_function,std::initializer_list<std::string>{"command"}, [interpreter](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
            std::shared_ptr<andy::lang::object> command = params[0]->cls->functions["to_string"]->call(params[0]);
