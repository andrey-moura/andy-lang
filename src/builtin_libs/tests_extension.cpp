...
public:
    ...
    void load(andy::lang::interpreter* interpreter) override
    {
        ...
        expect_class->instance_functions["to"] = std::make_shared<andy::lang::function>("to", andy::lang::function_storage_type::instance_function, std::initializer_list<std::string>{"matcher_result"}, [interpreter](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
            // TODO refactor
