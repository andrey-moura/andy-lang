...
std::shared_ptr<andy::lang::structure> create_xml_page_class(andy::lang::interpreter* interpreter)
{
    auto xml_page_class = std::make_shared<andy::lang::structure>("XMLPage");
        xml_page_class->functions["new"] = std::make_shared<andy::lang::function>("new", andy::lang::function_storage_type::class_function,std::initializer_list<std::string>{}, [interpreter](std::shared_ptr<andy::lang::object> object, std::vector<std::shared_ptr<andy::lang::object>> params) {
